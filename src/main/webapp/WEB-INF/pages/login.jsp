...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="/WaterMeterMonitoringSystem/resources/vendors/animate.css/animate.min.css" rel="stylesheet">
          ...
          <section class="login_content">
            <form action="login" method="post">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> WaterMeter!</h1>
